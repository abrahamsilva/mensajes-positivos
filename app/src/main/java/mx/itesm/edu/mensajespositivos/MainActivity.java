...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        index = (int)(Math.random()* messages.length);
        ...
        animation.setEnterFadeDuration(7500);
        animation.setExitFadeDuration(7500);
        animation.start();
    ...
    public void checkHour(){
        ...
        if(hour<20){
            background.setBackgroundResource(R.drawable.day_animation);
        }
        else{
            background.setBackgroundResource(R.drawable.night_animation);
        }
    }
    ...
    public void goToIndex(View view){
        ...
        int i = Integer.parseInt(messageNumber.getText().toString());
        ...
        if(i>=messages.length){
            ...
            if (i < 0) {
                Toast.makeText(this,"Ingresa un número positivo",Toast.LENGTH_LONG).show();
            }
            else{
    ...
    private String [] messages= {"Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
